...
<form name="register_form_main" class="ui form <?php echo ($this->error ? "error" : ""); ?>" method="POST" action="register.php?red=<?php echo $this->ret_site_enc; ?>">
	<div class="field">
